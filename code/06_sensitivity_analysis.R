...
# Save output
ggsave(
  filename = file.path(dir_figures, "sensitivity_analysis_SI.pdf"),
  plot = gg_out,
  width = 180, height = 210, units = "mm", dpi = 300
)
